...
namespace LineEquationForTwoPointsTests
{
    public class EquationOfLineTest
    {
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(1));
            var p2 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(1));
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(10));
            var p2 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(3));
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(22), new DoubleCoordinate(1));
            var p2 = new Point<double>(new DoubleCoordinate(3), new DoubleCoordinate(1));
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(0), new DoubleCoordinate(0));
            var p2 = new Point<double>(new DoubleCoordinate(2), new DoubleCoordinate(-4));
            Assert.Equal($"y = -2x", new LineEquation<double>(p1, p2).ToString());
        }
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(0), new DoubleCoordinate(1));
            var p2 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(2));
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(0), new DoubleCoordinate(-1));
            var p2 = new Point<double>(new DoubleCoordinate(1), new DoubleCoordinate(0));
            Assert.Equal($"y = x - 1", new LineEquation<double>(p1, p2).ToString());
        }
        ...
        {
            var p1 = new Point<double>(new DoubleCoordinate(10), new DoubleCoordinate(10));
            var p2 = new Point<double>(new DoubleCoordinate(5), new DoubleCoordinate(20));
        ...
        {
            var x = new Point<double>(new DoubleCoordinate(-1), new DoubleCoordinate(3));
            var y = new Point<double>(new DoubleCoordinate(3), new DoubleCoordinate(11));
        ...
        {
            var x = new Point<double>(new DoubleCoordinate(6), new DoubleCoordinate(4));
            var y = new Point<double>(new DoubleCoordinate(2), new DoubleCoordinate(3));
